            ...
            <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-6">
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-gray-700">First Message</label>
                    <textarea
                      value={form.firstMessage}
                      onChange={e => setForm({ ...form, firstMessage: e.target.value })}
                      className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none h-24 transition-all"
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-gray-700">Scenario</label>
                    <textarea
                      value={form.scenario}
