"""
Django settings for ai_character_chat project.
...
MIDDLEWARE = [
    'cors_middleware.SimpleCorsMiddleware',  # Add custom CORS middleware
...
ROOT_URLCONF = 'ai_character_chat.urls'
...
WSGI_APPLICATION = 'ai_character_chat.wsgi.application'
...
# CORS settings for development (temporary manual implementation)
